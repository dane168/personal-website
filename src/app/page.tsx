...
export default async function Home() {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col bg-gradient-to-r from-cyan-600 to-cyan-500 dark:from-black dark:to-slate-900">
        <div className="bg-gradient-to-r from-cyan-600 to-cyan-500 dark:from-black dark:to-slate-900">
        ...
        <div className="grow bg-white dark:bg-slate-900 rounded-2xl md:rounded-[4rem]">

          <div className="h-16 relative -top-8 rounded-full shadow-2xl overflow-hidden max-w-[1200px] mx-6 md:mx-auto">
            <nav className=" text-sm sm:text-base md:text-xl h-full md:overflow-hidden flex flex-row justify-evenly items-center bg-white dark:bg-slate-800">
              <div className="py-3 mx-auto md:mx-8 font-bold">
          ...
          <div className="">
            <div id="about-me" className="px-4 mb-20  text-left max-w-[1000px] md:mx-auto">
            ...
            <div id="my-tech-stack" className="mb-24 text-center">
